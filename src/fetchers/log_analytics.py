"""
Log Analytics fetcher — Copilot Studio OTel telemetry via KQL.

Queries AppEvents (conversation turns) and AppDependencies (connector calls,
AI model calls) from a Log Analytics workspace.
"""
